...
Runs standard 30s on/off block design with visual stimulation for piloting.
...
stimDurTotal = nrTrials * stimDur  # sum stimulus durations
restDurTotal = nrTrials * restDur  # sum rest durations
...
while runExp:
    ...
    if triggerSwitch:
        ...
        if trialTime.getTime() <= stimDur:
            ...
            if stimSwitch and visStimTime.getTime() >= 1/stimFrameRate:
...
# Detection ratio
DetectRatio = detectedTargets / targetCounter
