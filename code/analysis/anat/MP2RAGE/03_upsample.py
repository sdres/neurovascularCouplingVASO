...
for sub in SUBS:
    ...
    # =============================================================================
    inDir = f"{DATADIR}/derivatives/{sub}/ses-01/anat"
    outDir = f"{DATADIR}/derivatives/{sub}/ses-01/anat/upsample"
    ...
    images = sorted(glob.glob(f'{DATADIR}/{sub}/ses-01/anat/*inv-2*.nii.gz'))
