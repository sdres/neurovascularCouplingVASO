...
for sub in ['sub-01']:
    ...
    # for modality in ['bold', 'cbv']:
        ...
        if modality == 'bold':
            ...
            nb.save(img, f'{outFolder}'
                + f'/{sub}_task-stimulation_part-mag_{modality}_intemp_test.nii.gz'
                )
    ...
    cbvFile = f'{outFolder}/{sub}_task-stimulation_part-mag_cbv_intemp.nii.gz'
    boldFile = f'{outFolder}/{sub}_task-stimulation_part-mag_bold_intemp.nii.gz'
